...
def main():
    ...
    adt_df_from_txt.to_csv(
        f"./Archive/Modified/ADT_{today}_Modified_file.csv", index=False
    )
    oru_df_from_txt.to_csv(
        f"./Archive/Modified/ORU_{today}_Modified_file.csv", index=False
    )
